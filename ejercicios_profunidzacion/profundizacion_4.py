...
print("Temperatura máxima encontrada {}. Temperatura máxima con la función max {}".format(temperatura_max,temp_max))
temp_min = min(temp_dataloger)
print("Temperatura mínima encontrada {}. Temperatura mínima con la función max {}".format(temperatura_min,temp_min))
...
print("sumatoria: {}. suma con funcion sum: {}".format(temperatura_sumatoria,suma))
'''
...
'''
if (temp_min >= 19) and (temp_max <= 28):
    print("Nos encontramos en VERANO")
elif (temp_min >= 11) and (temp_max <= 20):
    print("Nos encontramos en OTOÑO")
elif (temp_min >= 8) and (temp_max <= 14):
    print("Nos encontramos en INVIERNO")
elif (temp_min >= 10) and (temp_max <= 24):
    print("Nos encontramos en PRIMAVERA")
else:
    print("No puedo deducir en que estación estamos")
